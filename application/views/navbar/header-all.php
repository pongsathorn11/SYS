...
<head>
    ...
    <link href="{base_url}assets/extra-libs/datatables.net-bs4/css/responsive.dataTables.min.css" rel="stylesheet" >
    <!-- Custom CSS -->
            ...
            <nav class="navbar top-navbar navbar-expand-lg">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <div class="navbar-brand">
                        <!-- Logo icon -->
                        <a href="index.html">
                            <img src="{base_url}assets/images/freedashDark.svg" alt="" class="img-fluid">
                        </a>
                    </div>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link" href="{base_url}datatable/index" aria-expanded="false"><i data-feather="tag" class="feather-icon"></i><span class="hide-menu">DataTable
                                </span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="{base_url}form/index" aria-expanded="false"><i data-feather="message-square" class="feather-icon"></i><span class="hide-menu">Form</span></a></li>
